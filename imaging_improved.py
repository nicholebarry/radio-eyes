...
# same as wk2 imaging template but added code to only graph the points within a specfic ra and dec range
import astropy 
...
ra_zoom = [4.4,4.6] #vals that get good image: [11.7, 12.1]
dec_zoom = [-22.5,-22.2] #vals that get good image: [-25.45, -25.15]
